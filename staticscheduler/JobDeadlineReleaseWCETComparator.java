...
public class JobDeadlineReleaseWCETComparator implements Comparator<Job>
{
	public int compare( Job x, Job y)
	{
		// sort jobs in order of increasing deadline
		...
		{
			// if jobs have the same deadline, they are sorted in order of increasing release time
